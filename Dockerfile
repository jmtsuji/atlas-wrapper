...
RUN /bin/bash -c "source activate atlas_env"
RUN /bin/bash -c "pip install -U 'pnnl-atlas==1.0.22'"
RUN /bin/bash -c "mkdir -p /home/atlas"

ENTRYPOINT cd /home/atlas && /bin/bash -c "source activate atlas_env" && /bin/bash
